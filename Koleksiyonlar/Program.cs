...
namespace Koleksiyonlar
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine(isimler[4]);// Arraylerde sabitlik var.Yani bir arrayi 4 elemanlı tanımladığımızda onu 5 elemanlı yapsak bile
                                            //DEVAMI: 'new' demek gerektiği için yeni elemanı eklesek bile eski elemanları kaybediyoruz.
