namespace OOP3
{
    interface IKrediManager// İnterface derki  birisi bu interface'i kullanırsa o arkadaş bu metodu içermeli.(Hesapla metodunu kastediyoruz ya da BiseyYap metodunu.)
