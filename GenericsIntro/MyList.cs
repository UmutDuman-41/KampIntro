...
namespace GenericsIntro
{
    ...
    class MyList<T>         // Biz MyList te T ile çalışacağız.T yerine başka bir şey de yazabiliriz.İstersek string,double hatta bir class bile koyabilirdik.
    {
        ...
        public void Add(T item) // Yeni bir eleman eklemek istediğimizde MyList.Add deiğimizde bir eleman eklemek istedik ama liste 0 elemanlı olduğu için önce eleman sayısını new ile aşağıda arttırdık.
        {
